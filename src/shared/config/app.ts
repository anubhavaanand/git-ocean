...
export const appConfig = {
   ...
   * @env VITE_APP_NAME
   */
  name: import.meta.env['VITE_APP_NAME'] || 'Git Ocean',
   ...
   * @env VITE_APP_ID
   */
  id: import.meta.env['VITE_APP_ID'] || 'git-ocean',
   ...
   */
  tokenPrefix: import.meta.env['VITE_TOKEN_PREFIX'] || 'go_',
   ...
   * @env VITE_GITHUB_URL
   */
  githubUrl: import.meta.env['VITE_GITHUB_URL'] || 'https://github.com/anubhavaanand/git-ocean',
   ...
   */
  brand: {
    primaryColor: import.meta.env['VITE_APP_PRIMARY_COLOR'] || '#06B6D4',
